    ...
    return (
        <Link 
            ...
            <div className={`product-buttons ${hover}`}>
                <Link className='link' onClick={(e) => e.preventDefault()} ><div onClick={() => {setModal('modal-delete-product'); setId(product.id)}} className='product-button delete-button'>Delete</div>  
                </Link>
            </div>
